...
class StatusResponseHandler implements XmlResponseHandler<Status> {
	...
	public ContentHandler getContentHandler() {
		...
		root.getChild("", "volume").setEndTextElementListener(
		...
		root.getChild("", "length").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "time").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "state").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "position").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "fullscreen").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "random").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "loop").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		root.getChild("", "repeat").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "title").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "artist").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "genre").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "copyright").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "album").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "track").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "description").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "rating").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "date").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "url").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "language").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "now_playing").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "publisher").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "encoded_by").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "art_url").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
		...
		meta.getChild("", "track_id").setEndTextElementListener(
				new EndTextElementListener() {
					/** {@inheritDoc} */
					public void end(String body) {
